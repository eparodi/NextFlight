...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                CharSequence entry_string = listPreference.getEntries()[index];

                if (preference.getKey().equals("currency_list")) {
                    SettingsManager.setCurrency(listPreference.getEntries()[index].toString(), SettingsManager.settings_context);
                }

                if (entry_string.equals("Español") || entry_string.equals("Spanish")) {
                    //TODO: change to spanish language.
                }
                else if (entry_string.equals("Inglés") || entry_string.equals("English")) {
                    //TODO: change to english language.
                }
    ...
    public static class LanguagePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            SharedPreferences shared_preferences = PreferenceManager.getDefaultSharedPreferences(preference.getContext());
            */
        }
